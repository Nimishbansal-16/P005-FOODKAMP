...
class _AdminHomePageState extends State<AdminHomePage> {
        ...
        physics: ScrollPhysics(),
          child: Column(
            children: <Widget>[
              ...
              stream: Firestore.instance.collection('restaurants').document(authNotifier.user.uid).collection('items').snapshots(),
                  ...
                  if(_suggestionList.length > 0){
                    ...
                    child:ListView.builder(
                      ...
                      return ListTile(
                        ...
                        trailing: Column(
                          children: [
                            Text('Total Quantity: ${_suggestionList[i].totalQty.toString()}'),
                            Text('Time: ${_suggestionList[i].time.toString()} min'),
                          ],
                        ),
                        onLongPress: () {
                          showDialog(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      validator: (String value) {
                        if(value.length > 3  || value.startsWith('-')) return "Not a valid price";
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      validator: (String value) {
                        ...
                        else if(value.startsWith('-') ) return "Qty cannot be negative";
                        else return null;
                      },
                      keyboardType: TextInputType.numberWithOptions(),
                      onSaved: (String value) {
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      validator: (String value) {
                        ...
                        if(value.length > 2  || value.startsWith('-')) return "Not a valid time";
                        else if(int.tryParse(value) == null) return "Not a valid integer";
                        else return null;
                      },
                      keyboardType: TextInputType.numberWithOptions(),
                    ...
                    child: GestureDetector(
                      onTap: () {
                        if (_formKey.currentState.validate()) {
                          ...
                          addNewItem(itemName, price, totalQty,time, context, authNotifier.user.uid,);
                        }
                      },
  ...
  Widget popupEditForm(context, Food data){
    ...
    int totalQty = data.totalQty, price = data.price, time = data.time;
    return SingleChildScrollView(
      physics: ScrollPhysics(),
      child: AlertDialog(
        content: Stack(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        if (_formKeyEdit.currentState.validate()) {
                          ...
                          editItem(itemName, price, totalQty,time, context, data.id, authNotifier.user.uid);
                        }
                      },
          ...
          Column(
            ...
            children: <Widget>[
              Padding(
                ...
                child: GestureDetector(
                  onTap: () {
                    deleteItem(data.id, context,authNotifier.user.uid);
                  },
              ...
              Padding(
                ...
                child: GestureDetector(
                  onTap: () {
                    editItem(data.itemName, data.price, 0,data.time, context, data.id,authNotifier.user.uid);
                  },
