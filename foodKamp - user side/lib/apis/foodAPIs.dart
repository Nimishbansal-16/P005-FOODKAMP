...
updateUserData(String name, String phone) async {
...
placeOrder(BuildContext context, double total, String restaurantID2,String time_of_arrival,String restaurantname) async {
  pr = new ProgressDialog(context, type: ProgressDialogType.Normal, isDismissible: false, showLogs: false);
  pr.show();
  try {
    // Initiaization
    ...
    CollectionReference userRef = Firestore.instance.collection('users');
    // DocumentReference orderid = Firestore.instance.collection('orders').document()
    ...
    await Firestore.instance.runTransaction((Transaction transaction) async {
        ...
        await orderRef
          ...
          .setData({
            ...
            "placed_to": restaurantID2,
            // "id": orderRef.document().documentID
    ...
    Navigator.pushAndRemoveUntil(
      context,
      MaterialPageRoute(builder: (context) => NavigationBarPage(selectedIndex: 2)),
...
Future<void> timecheck(String restaurantID2, TimeOfDay time2) async{
  ...
  String closetime = restro[0]['Close_time'];
    ...
    if(_opentime.hour <= time2.hour && time2.hour< _closetime.hour){
