      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: <Widget>[
            ...
            (widget.orderdata['is_delivered']== 'Pending')? ( QrImage(data: widget.orderdata.documentID,
                  size: 250,)): Text(""),
            ...
            Text(
              "Reaching Time: ${widget.orderdata['time_of_arrival']}",
              style: TextStyle(
                color: Colors.black,
                fontSize: 20,
                fontFamily: 'MuseoModerno',
            ...
            (widget.orderdata['is_delivered']=='Pending')? GestureDetector(
              onTap: () {
